...
import type { LLMProvider, RawArticle, Enrichment, Category, Audience } from '../types.js';
...
出力形式（厳密なJSON）:
{"summary_ja":"日本語6〜8行程度の要約（各要点を具体的に記述）","category":"update または tips または business または case_study","importance_score":1から10の整数,"importance_reason":"重要な理由を10〜15字程度で（例:破壊的変更）","tags":["トピックタグ","2〜3個"],"audience":"engineer または backoffice または executive","difficulty":1から3の整数}
